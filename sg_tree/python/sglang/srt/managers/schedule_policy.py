...
class PrefillAdder:
    ...
    def add_one_req(
        ...
        with self._lock_node(req.last_node):
            ...
            if self.rem_chunk_tokens is None or input_tokens <= self.rem_chunk_tokens or getattr(req, 'is_tree_attention', False):
                # Non-chunked prefill (tree attention requests must not be chunked)
                self.can_run_list.append(req)
