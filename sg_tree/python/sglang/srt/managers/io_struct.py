...
class GenerateReqInput(BaseReq, APIServingTimingMixin):
    ...
    # Tree attention: parent_ids[i] is the index of token i's parent in input_ids.
    # -1 means root. Enables tree-structured attention mask in a single forward pass.
    parent_ids: Optional[Union[List[List[int]], List[int]]] = None
    ...
    def __getitem__(self, i):
        return GenerateReqInput(
            ...
            parent_ids=(
                self.parent_ids[i] if self.parent_ids is not None else None
            ),
