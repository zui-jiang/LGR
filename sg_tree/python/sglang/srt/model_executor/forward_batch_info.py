...
class ForwardBatch:
    ...
    def init_new(
        ...
        ret = cls(
            ...
            is_tree_attention=batch.is_tree_attention,
            tree_custom_mask=batch.tree_custom_mask,
            tree_mask_indptr=batch.tree_mask_indptr,
            tree_logprob_parent_indices=batch.tree_logprob_parent_indices,
        )
        ...
        elif ret.is_tree_attention and batch.tree_positions is not None:
            ret.positions = batch.tree_positions
